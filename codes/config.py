...
PREPARED_TRAINING_SET_PATH = "../results/POD-10YEAR_vars=4_modes=1000_BASE-DATA/reduced_training_set/xr.npy"
SUBTRACTED_PATH = "../results/POD-10YEAR_vars=4_modes=1000_BASE-DATA/subtract/x_sub.npy"
BASIS_PATH = "../results/POD-10YEAR_vars=4_modes=1000_BASE-DATA/basis/reduced_basis_modes=1000.npy"
SCALER_PATH = "../results/POD-10YEAR_vars=4_modes=1000_BASE-DATA/scaler/scaler.pkl"
NUM_POD_MODES = 1000 # only if PREPARED_TRAINING_SET_PATH = None, int > 1 or float < 1
